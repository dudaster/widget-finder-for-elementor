...
/**
 * Search interface for the widget dataset stored in {prefix}wfx_widgets.
 *
 * Data is imported from data/widgets.json at activation time by WFX_Importer.
...
class WFX_Database {
	...
	public static function search( string $query, int $limit = 20, int $offset = 0 ): array {
		...
		$table = $wpdb->prefix . WFX_Importer::TABLE_WIDGETS;
