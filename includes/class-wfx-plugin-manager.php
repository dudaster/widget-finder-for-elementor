...
class WFX_Plugin_Manager {
	...
	public static function install( string $slug ) {
		if ( ! current_user_can( 'install_plugins' ) ) {
			return new WP_Error( 'permission_denied', __( 'You do not have permission to install plugins.', 'widget-finder-for-elementor' ) );
		}
	...
	public static function activate( string $plugin_file ) {
		if ( ! current_user_can( 'activate_plugins' ) ) {
			return new WP_Error( 'permission_denied', __( 'You do not have permission to activate plugins.', 'widget-finder-for-elementor' ) );
		}
